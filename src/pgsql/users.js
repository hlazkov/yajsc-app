import { executeQuery } from './pgConnection.js';
import { uuid } from "../utils.js";

const defaultAdminRoleId = "a9177d9f-31ad-4686-a44e-b784f5791a4f";

export const selectAllUsers = async () => {
    return await executeQuery(`SELECT id, username, role_id, firstname, lastname, phone, email, telegram, curator_id FROM public.users;`);
}
...
export const insertUser = async (user, id) => {
    ...
    return await executeQuery(`INSERT INTO public.users
        ...
        VALUES('${normalizedUser.id}'::uuid, '${normalizedUser.username}', '${normalizedUser.roleId}'::uuid, '${normalizedUser.firstname || 'NULL'}', ${normalizedUser.lastname || 'NULL'}, ${normalizedUser.phone || 'NULL'}, ${normalizedUser.email || 'NULL'}, ${normalizedUser.telegram || 'NULL'}, ${normalizedUser.curatorId || 'NULL'});`);
}
